        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="#services" className="text-muted-foreground hover:text-primary transition-colors">Hizmetlerimiz</a>
              </li>
              <li>
                <a href="#technologies" className="text-muted-foreground hover:text-primary transition-colors">Teknolojiler</a>
              </li>
              <li>
                <a href="#products" className="text-muted-foreground hover:text-primary transition-colors">Ürünler</a>
              </li>
              <li>
                <a href="#sectors" className="text-muted-foreground hover:text-primary transition-colors">Sektörler</a>
              </li>
            </ul>
          </div>
